...
class ServiceCategory extends Model
{
    ...
    public function scopeLegalProductByMonth($query, $year)
    {
        return $query->select(
            ...
            DB::raw("SUM(CASE WHEN MONTH(b.created_at) = 1 AND YEAR(b.created_at) = ".$year." THEN 1 ELSE 0 END) AS 'january'"),
            DB::raw("SUM(CASE WHEN MONTH(b.created_at) = 2 AND YEAR(b.created_at) = ".$year." THEN 1 ELSE 0 END) AS 'february'"),
            DB::raw("SUM(CASE WHEN MONTH(b.created_at) = 3 AND YEAR(b.created_at) = ".$year." THEN 1 ELSE 0 END) AS 'march'"),
            DB::raw("SUM(CASE WHEN MONTH(b.created_at) = 4 AND YEAR(b.created_at) = ".$year." THEN 1 ELSE 0 END) AS 'april'"),
            DB::raw("SUM(CASE WHEN MONTH(b.created_at) = 5 AND YEAR(b.created_at) = ".$year." THEN 1 ELSE 0 END) AS 'may'"),
            DB::raw("SUM(CASE WHEN MONTH(b.created_at) = 6 AND YEAR(b.created_at) = ".$year." THEN 1 ELSE 0 END) AS 'june'"),
            DB::raw("SUM(CASE WHEN MONTH(b.created_at) = 7 AND YEAR(b.created_at) = ".$year." THEN 1 ELSE 0 END) AS 'july'"),
            DB::raw("SUM(CASE WHEN MONTH(b.created_at) = 8 AND YEAR(b.created_at) = ".$year." THEN 1 ELSE 0 END) AS 'august'"),
            DB::raw("SUM(CASE WHEN MONTH(b.created_at) = 9 AND YEAR(b.created_at) = ".$year." THEN 1 ELSE 0 END) AS 'september'"),
            DB::raw("SUM(CASE WHEN MONTH(b.created_at) = 10 AND YEAR(b.created_at) = ".$year." THEN 1 ELSE 0 END) AS 'october'"),
            DB::raw("SUM(CASE WHEN MONTH(b.created_at) = 11 AND YEAR(b.created_at) = ".$year." THEN 1 ELSE 0 END) AS 'november'"),
            DB::raw("SUM(CASE WHEN MONTH(b.created_at) = 12 AND YEAR(b.created_at) = ".$year." THEN 1 ELSE 0 END) AS 'december'"),
